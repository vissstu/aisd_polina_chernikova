...
private:
    ...
    std::size_t number_of_vertexs; // Количество вершин 
    std::size_t max_number_vertexs; // Максимальная емкость массива вершин 
...
public:
    ...
    // Метод для получения текущего числа вершин
    size_t size() const
    {
